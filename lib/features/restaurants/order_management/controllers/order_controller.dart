...
class OrderController extends GetxController {
  ...
  final List<Order> allOrders = [
    Order(
      ...
      orderItems: [
        OrderItem(orderItemId: 1, orderId: 1455324234, itemId: 3, quantity: 1),
        OrderItem(orderItemId: 2, orderId: 1455324234, itemId: 4, quantity: 2),
        OrderItem(orderItemId: 3, orderId: 1455324234, itemId: 5, quantity: 2),
      ],
    ),
    Order(
      orderId: 21455324234,
      ...
      orderItems: [
        OrderItem(orderItemId: 3, orderId: 21455324234, itemId: 5, quantity: 1),
      ],
    ),
    Order(
      orderId: 31455324234,
      ...
      orderItems: [
        OrderItem(orderItemId: 4, orderId: 31455324234, itemId: 6, quantity: 3),
      ],
    ),
    Order(
